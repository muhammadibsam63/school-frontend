...
function validate(form) {
  ...
  if (form.age === '' || form.age === null) {
    ...
    errors.age = 'Age must be a whole number between 1 and 119';
  }
...
export default function StudentFormModal({ student, onClose, onSubmit, submitting, serverError }) {
    ...
    <div className="modal-overlay" role="presentation" onMouseDown={onClose}>
      ...
      >
        <div className="modal__header">
          <h2 id="student-modal-title" className="modal__title">
            ...
            <div className="field-row">
              ...
              <div className="field">
                ...
                <input
                  id="course"
                  type="text"
                  className={`field__input ${errors.course ? 'field__input--error' : ''}`}
                  value={form.course}
                  onChange={handleChange('course')}
                  placeholder="e.g. Computer Science"
                />
                {errors.course && <p className="field__error">{errors.course}</p>}
              </div>
            </div>
          </div>
